/**
 * $Id: 90e2134eadc61fc89e8f047bdac3bc5dad104194 $
 * <p>
 * Unpublished work.
...
public class PrimitivesBundle extends StringConverterExtension {
    ...
    private static Icon iconFromUrl(final String s) throws MalformedURLException {
        return new ImageIcon(new URL(s));
    }

    private static Image imageFromUrl(final String s) throws MalformedURLException {
        return new ImageIcon(new URL(s)).getImage();
    }

    @Override
    public void extendTypeMap(final StringConverter registry) {
        // Primitives
